...
class MessagesController extends Controller
{
    ...
    public function renderConversationUserAction($conversation)
    {
        ...
        return $this->render('@App/Messages/_conversation_user.html.twig', ['messages' => array_reverse($messages, true)]);
    }
    ...
    public function renderConversationAdminAction($conversation)
    {
        ...
        return $this->render('@App/Messages/_conversation_admin.html.twig', ['messages' => array_reverse($messages, true)]);
    }
